...
class vizCM:
    def __init__(self, G,U, verbose=False, threshold=0.1, gt_labels=None, spring_layout=None,isolates=None):
        ...
        self.algos = list(self.U.keys())
        self.K = self.U[self.algos[0]].shape[1]
        ...
        if gt_labels is not None:
            ...
            self.nodelist = sort_nodelist_by_community(self.community_H[self.algos[0]])
    ...
    def set_node_attributes(self, A, algo='Exp'):
